...
### 模型支持
- **多版本模型支持**：支持 PP-OCRv4、PP-OCRv5 和 PP-OCRv6 模型，灵活选择使用
...
### PP-OCRv6
- **最新版本**：新一代OCR解决方案，准确率更高。
- **增强能力**：
  - 改进的复杂布局和密集文本检测。
  - 多语言场景识别准确率提升。
  - 准确率和速度双重优化。
- **模型文件**：
  - 检测模型：`PP-OCRv6_mobile_det.mnn`
  - 识别模型：`PP-OCRv6_mobile_rec.mnn`
  - 字符集：`ppocr_keys_v6.txt`

### 模型性能对比

| 特性               | PP-OCRv4 | PP-OCRv5 | PP-OCRv5 FP16 | PP-OCRv6 |
|--------------------|----------|----------|---------------|----------|
| 语言支持           | 中文、英文 | 多语言（默认支持中文/英文/日文，提供11+种专用语言模型） | 多语言（默认支持中文/英文/日文，提供11+种专用语言模型） | 多语言（增强） |
| 文字类型支持       | 中文、英文 | 简体中文、繁体中文、英文、日文、中文拼音 | 简体中文、繁体中文、英文、日文、中文拼音 | 简体中文、繁体中文、英文、日文、中文拼音 |
| 手写体识别         | 基础支持  | 显著增强  | 显著增强       | 显著增强 |
| 竖排文本           | 基础支持  | 优化提升  | 优化提升       | 优化提升 |
| 生僻字识别         | 有限支持  | 增强识别  | 增强识别       | 增强识别 |
| 复杂布局           | 基础支持  | 良好     | 良好           | 优秀 |
| 推理速度 (FPS)     | 1.1      | 1.2      | 1.2           | 1.2 |
| 内存使用 (峰值)    | 422.22MB | 388.41MB | 388.41MB      | ~380MB |
| 模型大小           | 标准      | 标准      | 减半           | 标准 |
| 推荐场景           | 常规文档  | 复杂场景与多语言 | 高性能场景与多语言 | 最新、最佳准确率 |
